...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO services (name, description, price, duration, category, project_id) 
            VALUES ('$name', '$description', '$price', '$duration', '$category', $project_id)";

    if ($conn->query($sql) === TRUE) {
        header("Location: list.php?success=Service added successfully");
        exit();
    } else {
